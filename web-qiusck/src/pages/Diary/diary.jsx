...
const Diary = () => {
  return (
    <>
      ...
      <SingleDiaryComponent backgroundImage={cityImage}  titleImage={diaryImage} degree="ناخدا" name="هوشنگ صمدی"  diary="خاطره نجات سرباز رایان"  quete="زمانی که ناقوس مرگ به صدا در آمد جایی برای فرار نیست" videoItem={samadi}  />
